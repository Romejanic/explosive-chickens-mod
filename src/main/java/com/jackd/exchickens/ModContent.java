...
public class ModContent {
    ...
    public static final Item CHICKEN_HELMET = registerItem("chicken_helmet", new ArmorItem(CHICKEN_ARMOR, ArmorItem.Type.HELMET, new Item.Settings().maxDamage(ArmorItem.Type.HELMET.getMaxDamage(4))), ItemGroups.COMBAT);
    public static final Item CHICKEN_CHESTPLATE = registerItem("chicken_chestplate", new ArmorItem(CHICKEN_ARMOR, ArmorItem.Type.CHESTPLATE, new Item.Settings().maxDamage(ArmorItem.Type.CHESTPLATE.getMaxDamage(4))), ItemGroups.COMBAT);
    public static final Item CHICKEN_LEGGINGS = registerItem("chicken_leggings", new ArmorItem(CHICKEN_ARMOR, ArmorItem.Type.LEGGINGS, new Item.Settings().maxDamage(ArmorItem.Type.LEGGINGS.getMaxDamage(4))), ItemGroups.COMBAT);
    public static final Item CHICKEN_BOOTS = registerItem("chicken_boots", new ArmorItem(CHICKEN_ARMOR, ArmorItem.Type.BOOTS, new Item.Settings().maxDamage(ArmorItem.Type.BOOTS.getMaxDamage(4))), ItemGroups.COMBAT);
    public static final Item COOKED_CHICKEN_HELMET = registerItem("cooked_chicken_helmet", new ArmorItem(COOKED_CHICKEN_ARMOR, ArmorItem.Type.HELMET, new Item.Settings().maxDamage(ArmorItem.Type.HELMET.getMaxDamage(4)).component(ARMOR_COOKABLE_COMPONENT, ArmorCookableComponent.defaultWithItem(CHICKEN_HELMET))), ItemGroups.COMBAT);
    public static final Item COOKED_CHICKEN_CHESTPLATE = registerItem("cooked_chicken_chestplate", new ArmorItem(COOKED_CHICKEN_ARMOR, ArmorItem.Type.CHESTPLATE, new Item.Settings().maxDamage(ArmorItem.Type.CHESTPLATE.getMaxDamage(4)).component(ARMOR_COOKABLE_COMPONENT, ArmorCookableComponent.defaultWithItem(CHICKEN_CHESTPLATE))), ItemGroups.COMBAT);
    public static final Item COOKED_CHICKEN_LEGGINGS = registerItem("cooked_chicken_leggings", new ArmorItem(COOKED_CHICKEN_ARMOR, ArmorItem.Type.LEGGINGS, new Item.Settings().maxDamage(ArmorItem.Type.LEGGINGS.getMaxDamage(4)).component(ARMOR_COOKABLE_COMPONENT, ArmorCookableComponent.defaultWithItem(CHICKEN_LEGGINGS))), ItemGroups.COMBAT);
    public static final Item COOKED_CHICKEN_BOOTS = registerItem("cooked_chicken_boots", new ArmorItem(COOKED_CHICKEN_ARMOR, ArmorItem.Type.BOOTS, new Item.Settings().maxDamage(ArmorItem.Type.BOOTS.getMaxDamage(4)).component(ARMOR_COOKABLE_COMPONENT, ArmorCookableComponent.defaultWithItem(CHICKEN_BOOTS))), ItemGroups.COMBAT);
